    ...
    <div class="lg:mt-[50px]">
        ...
        <div class="flex flex-col lg:flex-row">
            <div class="hidden lg:w-1/3 lg:flex flex-col items-start px-8 my-8 border-r-[1px] border-darkergreen">
                <a href="<?php echo home_url('/jobs/'); ?>" class="w-fit text-center text-base text-darkergreen border-darkergreen border-2 hover:bg-darkergreen hover:text-white px-10 p-2 rounded-full">Back to jobs</a>
                <div class="">
            ...
            <div class="lg:w-2/3 p-5 lg:p-8 flex flex-col gap-10 lg:gap-[50px]">
                <div class="flex flex-col gap-4">
                    <div class="flex flex-row gap-5 justify-between">
                        <div class="flex flex-col gap-5 w-full">
                            ...
                            <a href="<?php echo $job_application_link = get_post_meta(get_the_ID(), 'job_application_link', true); ?>" class="w-fit text-base text-darkergreen text-center border-darkergreen hover:bg-darkergreen hover:text-white border-2 px-10 py-2 rounded-full">Apply</a>
                        </div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <?php } else { ?>
                            <p id="voluntary" class="text-base text-black flex flex-row gap-1 unspecified"><strong class="min-w-[180px]">Pay:</strong>£<?php echo format_salary(get_post_meta(get_the_ID(), 'job_salary', true)); ?></p>
                        <?php  } ?>
                        ...
                        <p class="text-base text-black flex flex-row gap-1"><strong class="min-w-[180px]">Supplemental pay types:</strong> <?php echo $job_supplemental_pay = get_post_meta(get_the_ID(), 'job_supplemental_pay', true); ?></p>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="<?php echo $job_application_link = get_post_meta(get_the_ID(), 'job_application_link', true); ?>" class="w-fit text-base text-center text-darkergreen border-darkergreen hover:bg-darkergreen hover:text-white border-2 px-10 py-2 rounded-full">Apply</a>
                    <?php if ($job_downloads_one) { ?>
                        <a href="<?php echo $job_downloads_one; ?>" target="_blank" class="text-base text-darkergreen hover:underline hover:text-darkergreen w-fit">About employer</a>
                    <?php }
                    if ($job_downloads_two) { ?>
                        <a href="<?php echo $job_downloads_two; ?>" target="_blank" class="text-base text-darkergreen hover:underline hover:text-darkergreen w-fit">Extra job information</a>
                    <?php  } ?>
