(() => {
  ...
  jQuery(document).ready(function($) {
    ...
    $("#job-filter-form, #mobile-job-filter-form, #when_published, #when_published_mobile").on("change", function(event2) {
      event2.preventDefault();
      ...
      filterData.published = $("#when_published_mobile").val() || filterData.published;
    ...
    $("#search-input").keydown(function(event2) {
      if (event2.key === "Enter") {
        event2.preventDefault();
      }
    });
    ...
    function filterJobs(page2, searchQuery = "") {
      if (searchQuery === "") {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.success) {
            ...
            console.log("Posts returned:", parseInt(postCount) + parseInt(response.data.posts_returned));
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    dropdowns.forEach((dropdown) => {
      dropdown.addEventListener("click", function(event2) {
        event2.preventDefault();
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (searchForm) {
      searchForm.addEventListener("keydown", function(event2) {
        if (event2.key === "Enter") {
          event2.preventDefault();
        }
      });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (logoutMenuItem) {
      logoutMenuItem.addEventListener("click", function(event2) {
        event2.preventDefault();
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const subMenu = document.querySelector("#secondary-menu #menu-secondary-menu li .sub-menu");
    if ((currentUrl === myjobsUrl || currentUrl === myjobsUrlWithSlash) && loginForm && subMenu) {
      subMenu.style.display = "none";
    }
  });
  document.addEventListener("DOMContentLoaded", function() {
    const checkbox = document.querySelector("#volunteering");
    const hiddenfield = document.querySelectorAll(".hiddenfield");
    const salary = document.querySelector("#job_salary");
    if (checkbox) {
      checkbox.addEventListener("click", function() {
        console.log("clicked");
        isVolunteeringChecked();
      });
      isVolunteeringChecked();
    }
    function isVolunteeringChecked() {
      if (checkbox.checked) {
