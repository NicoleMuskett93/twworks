                    ...
                    ?>
                        ...
                        <form class="flex flex-col gap-3" id="job_form_<?php echo esc_attr($job_post->ID); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col items-start gap-2 lg:flex-row lg:gap-5 lg:items-center">
                                ...
                                <input class="w-full lg:w-3/4 bg-lightergreen rounded px-5 py-3" type="number" id="job_salary" name="job_salary" placeholder="£26,000 a year - Full-time" value="<?php echo esc_attr($job_salary); ?>" required />
                            </div>

                         
                            <p>Enter 0 to show 'unspecified'</p>
                            ...
                            <div class="flex flex-col items-start gap-2 lg:flex-row lg:gap-5 lg:items-center">
                                ...
                                <select class="select-custom w-full lg:w-3/4 bg-lightergreen rounded px-5 py-3" id="job_sector" name="job_sector" required>
                                    ...
                                    <option value="Finance and Insurance" <?php selected($job_role, 'Education and Training'); ?>>Finance and Insurance</option>
