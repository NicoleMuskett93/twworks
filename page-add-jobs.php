            ...
            <div class="lg:w-2/3 lg:p-5">
                <div class="flex flex-col gap-3">
                    ...
                    <form class="flex flex-col gap-3" id="job_form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div id="salary_band" class="flex flex-col items-start gap-2 lg:flex-row lg:gap-5 lg:items-center">
                            <label class="text-base min-w-[130px]" for="job_salary">Salary</label>
                            <input class="w-full lg:w-3/4 bg-lightergreen rounded px-5 py-3" type="number" id="job_salary" name="job_salary" placeholder="e.g. £26,000" required />
                        </div>

                       
                        <p id="unspecified-text">Enter 0 to show 'unspecified'</p>
