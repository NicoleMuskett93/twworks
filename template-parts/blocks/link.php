...
<section id="<?= esc_attr($id); ?>" class="<?= esc_attr($className); ?> hero-height">
    <div class="h-full flex justify-center items-center "style="background-image:url('<?php echo $background_image['url']; ?>'); background-size:cover; background-repeat: no-repeat; background-position: bottom;">
