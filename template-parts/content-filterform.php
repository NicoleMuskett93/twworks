        ...
        <div id="mobilefilters" class="hidden w-full lg:w-1/3 lg:flex flex-col items-center pb-[30px] lg:mt-5 lg:px-8 lg:my-8 lg:border-r-2 lg:border-lightgreen">
            ...
            <div class="post-filters w-full lg:max-w-96">
                ...
                <div class="flex flex-col gap-4 mt-4" method="get">
                    ...
                    <div class="flex">
                        <button id="filter-reset" class="mt-4 text-base border-2 border-darkergreen text-darkergreen hover:bg-darkergreen font-medium hover:text-white px-10 py-2 rounded-full w-1/2 lg:w-fit" type="reset">Clear Filters </button>
                    </div>
                </div>
</form>
